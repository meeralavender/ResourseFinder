    ...
    function showSuccessMessage(data) {
        ...
        modal.innerHTML = `
            ...
            <p style="color: #6b7280; margin-bottom: 1.5rem;">
                We're finding applications that match your profile...
            </p>
            <div style="background: #cffafe; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.5rem;">
                <p style="color: #0e7490; font-weight: 600;">
                    Found <span style="color: #06b6d4; font-size: 1.5rem;">3</span> applications for you!
                </p>
            </div>
            <button 
        ...
        localStorage.setItem('applicationsFormData', JSON.stringify(data));
