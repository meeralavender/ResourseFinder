    ...
    function showSuccessMessage(data) {
        ...
        modal.innerHTML = `
            ...
            <p style="color: #6b7280; margin-bottom: 1.5rem;">
                We're finding entrance exams that match your eligibility...
            </p>
            <div style="background: #ffedd5; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.5rem;">
                <p style="color: #9a3412; font-weight: 600;">
                    Found <span style="color: #f97316; font-size: 1.5rem;">4</span> exams for you!
                </p>
            </div>
            <button 
        ...
        localStorage.setItem('examsFormData', JSON.stringify(data));
